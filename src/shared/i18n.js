...
const i18nData = {
  ...
  'common.addToShortcuts': { 'zh-CN': '添加到捷径', 'en': 'Add to Shortcuts' },
  ...
  'common.shortcuts': { 'zh-CN': '捷径', 'en': 'Shortcuts' },
  'common.addShortcut': { 'zh-CN': '添加捷径', 'en': 'Add Shortcut' },
  'common.modifyShortcut': { 'zh-CN': '修改捷径', 'en': 'Modify Shortcut' },
  'common.shortcutTitle': { 'zh-CN': '捷径标题', 'en': 'Shortcut Title' },
  'common.shortcutUrl': { 'zh-CN': '捷径网址', 'en': 'Shortcut URL' },
  'common.shortcutAdded': { 'zh-CN': '捷径已添加', 'en': 'Shortcut added' },
  'common.shortcutDeleted': { 'zh-CN': '捷径已删除', 'en': 'Shortcut deleted' },
  'common.shortcutExists': { 'zh-CN': '该网址已存在', 'en': 'URL already exists' },
  'common.shortcutIconSize': { 'zh-CN': '捷径图标大小', 'en': 'Shortcut Icon Size' },
  'common.noHistory': { 'zh-CN': '暂无历史记录', 'en': 'No history' },
  'common.noShortcuts': { 'zh-CN': '暂无捷径', 'en': 'No shortcuts' },
  ...
  'backup.cloudManage': { 'zh-CN': '云端备份管理', 'en': 'Cloud Backup Management' },
  'backup.cloudManageDesc': { 'zh-CN': '查看、恢复和删除云端备份文件', 'en': 'View, restore and delete cloud backup files' },
  'backup.refreshList': { 'zh-CN': '刷新列表', 'en': 'Refresh List' },
  'backup.autoCleanup': { 'zh-CN': '自动清理旧备份', 'en': 'Auto Cleanup Old Backups' },
  'backup.autoCleanupDesc': { 'zh-CN': '自动清理比最近3个备份更早的备份文件', 'en': 'Automatically delete backups older than the 3 most recent' },
  'backup.noBackups': { 'zh-CN': '暂无备份文件', 'en': 'No backup files' },
  'backup.loadFailed': { 'zh-CN': '加载失败', 'en': 'Load failed' },
  'backup.restore': { 'zh-CN': '恢复', 'en': 'Restore' },
  'backup.delete': { 'zh-CN': '删除', 'en': 'Delete' },
  'backup.confirmRestore': { 'zh-CN': '确定要从 {filename} 恢复吗？这将覆盖当前书签。', 'en': 'Restore from {filename}? This will overwrite current bookmarks.' },
  'backup.confirmDelete': { 'zh-CN': '确定要删除备份文件 {filename} 吗？此操作不可恢复。', 'en': 'Delete backup file {filename}? This cannot be undone.' },
  'backup.deleteSuccess': { 'zh-CN': '删除成功', 'en': 'Delete successful' },
  'backup.deleteFailed': { 'zh-CN': '删除失败', 'en': 'Delete failed' },
  'backup.settingsSaved': { 'zh-CN': '设置已保存', 'en': 'Settings saved' },
  'webdav.enableFirst': { 'zh-CN': '请先启用 WebDAV 备份', 'en': 'Please enable WebDAV backup first' },
  ...
  'layout.shortcutIconSize': { 'zh-CN': '捷径图标大小', 'en': 'Shortcut Icon Size' },
  'layout.shortcutIconSizeDesc': { 'zh-CN': '调整侧边栏捷径图标的尺寸（40-120像素）', 'en': 'Adjust sidebar shortcut icon size (40-120 pixels)' },
  ...
  'help.treeIndentHelp': { 'zh-CN': '调整树形目录中子文件夹的缩进 (0-20px)', 'en': 'Adjust tree indent (0-20px)' },
  'help.bookmarkIndentHelp': { 'zh-CN': '调整书签相对于目录的缩进 (0-20px)', 'en': 'Adjust bookmark indent (0-20px)' },
  ...
  'common.bookmarkAdded': { 'zh-CN': '书签已添加', 'en': 'Bookmark added successfully' },
